...
public class SellerDaoJDBC implements SellerDao {
    ...
    public void deleteById(Integer id) {
        ...
        try{
            ...
            int rowsaffected = st.executeUpdate();
            if(rowsaffected==0){
                throw new DbException("No seller with this Id!");
            }
        } catch (SQLException e) {
            throw new DbException(e.getMessage());
        }finally {
    ...
    public List<Seller> findAll() {
        ...
        ResultSet rs = null;
        try{
            st = conn.prepareStatement("SELECT seller.*,department.Name as DepName FROM seller INNER JOIN department ON seller.DepartmentId = department.Id ORDER BY seller.Id");
            rs = st.executeQuery();
